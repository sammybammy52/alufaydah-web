  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader className={`text-tetiary`}>Pay to Bank</ModalHeader>
          <ModalCloseButton className="text-red-600" />
          <ModalBody>
            <div action="">
              <div>
                <h1 className="mb-2">
                  <span className="font-semibold">Bank:</span>UBA Bank
                </h1>
                <h1 className="mb-2">
                  <span className="font-semibold">Name:</span>sihl Faydah
                  Project Account
                </h1>
              </div>
              <div className="flex items-center gap-2">
                ...
                />
                <CopyUrlButton
                  customDescription={"Copied Successfully"}
                  url={acc_no}
                />
              </div>
              ...
              <p className="mt-4 text-xs text-gray-600">
                <span className="font-semibold">NOTE:</span> After you make your
                payment you can reach out to us qspfreview@gmail.com to confirm
                your payment and then book(s) will be added to your digital
                library
              </p>
            </div>
          </ModalBody>
